...
const INTENTS = [
  ...
  },
  {
    ...
    "a": "«В карточке этого порта нет подтверждённого бара. Можно спросить у местных или у охраны порта. В любом случае: помни, что возвращение на судно в состоянии сильного опьянения может привести к списанию с судна за твой счёт. Правила проноса алкоголя на территорию порта отличаются от порта к порту — уточни у охраны на входе.»"
  },
  {
