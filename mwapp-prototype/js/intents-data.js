...
const INTENTS = [
  ...
  },
  {
    ...
    "a": "«Если ты про обычный вечерний отдых — бары и клубы отмечены в разделе «Развлечения» {названия}. Если вопрос про платные услуги — это лучше уточнить у Wellness Host в приложении (раздел Wellness, нужна карта профсоюза). Если столкнёшься с обманом или принуждением — сразу пиши в Дежурный офис IMWIRSA.»"
  },
  {
    ...
    "a": "«Мы не даём контактов и адресов — это вне нашей роли. Такие вопросы лучше уточнить у Wellness Host в приложении (раздел Wellness, нужна карта профсоюза). Если столкнёшься с принуждением или окажешься в опасности — сразу пиши в Дежурный офис IMWIRSA.»"
  },
  {
  ...
  },
  {
    ...
    "a": "«Мы не отслеживаем цены на такие услуги. Такой вопрос лучше уточнить у Wellness Host в приложении (раздел Wellness, нужна карта профсоюза). Если столкнулся с завышением цены или давлением — сразу пиши в Дежурный офис IMWIRSA, а при прямой угрозе — в полицию.»"
  },
  {
