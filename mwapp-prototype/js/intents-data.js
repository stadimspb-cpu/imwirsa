...
const INTENTS = [
  ...
  },
  {
    ...
    "a": "«Правила употребления CBD на борту зависят от судовладельца и судовой политики, а не только от законов страны — я не могу подтвердить конкретное международное правило без надёжного источника. Регулярное употребление CBD может повлиять на результат медосвидетельствования, и это может стать проблемой при снятии с рейса. Если сомневаешься — воздержись и уточни у судовладельца или судового агента.»"
  },
  {
  ...
  },
  {
    ...
    "a": "«Я не буду угадывать. Если в карточке этого Wellness указано, что массаж делает специалист или что это массажное кресло — покажу именно это. Если такого подтверждения нет, точнее скажет Wellness Host.»"
  },
  {
  ...
  },
  {
    ...
    "a": "«Wellness-зона создана для профессионального восстановления, а не для знакомств. Массажисты и хосты — специалисты, а не аниматоры. Если нужно просто поговорить или снять эмоциональное напряжение — есть центры моряков, капелланы или психологическая поддержка. Для этого обратись в Центральный офис IMWIRSA.»"
  },
  {
...
},
{
  ...
  "synonyms": [],
  "exclude": [],
  "a": "«Точный статус своего подключения к серверу прямо сейчас я тебе показать не могу — этого у меня пока нет. Но принцип такой: если соединения нет, я автоматически работаю офлайн — на заранее подготовленных данных и правилах; когда связь появляется, включается более гибкий онлайн-режим.»"
},
{
