...
// 13.09.2026, Andrey: "Центральный офис IMWIRSA" replaced with ISWAN here
// too -- this pool is exactly the same situation as Red Line (a real,
// ongoing emotional conversation), and the "Центральный офис" it pointed
// to had no real backend behind it. See redline.message's comment
// (i18n.js) for the full rationale and the verified ISWAN numbers.
const DEEP_TALK_LIMIT_REPLIES = [
  "Честно: офлайн я хожу примерно по одному и тому же кругу тёплых фраз — не хочу повторять одно и то же и делать вид, что это настоящий долгий разговор. Я рядом, но если это по-настоящему тяжело — лучше дождаться связи и написать в WhatsApp ISWAN, это бесплатная линия с живым человеком.",
  "Тут мои возможности офлайн правда ограничены — я не смогу вести этот разговор так долго, как, может, тебе хочется. Если не отпускает — напиши в WhatsApp ISWAN, когда будет связь, там всегда живой человек, — или дождись сети, и поговорим по-настоящему.",
  "Не хочу крутить один и тот же набор слов по кругу — офлайн я так устроен. Знай, что я рядом. А если совсем тяжело — это повод написать в WhatsApp ISWAN, как только появится связь, не только мне.",
  "Тема явно не закрыта, но офлайн я быстро упрусь в одни и те же ответы, и это будет только раздражать. Если хочется по-настоящему выговориться — напиши в WhatsApp ISWAN, как только будет связь, там бесплатно и конфиденциально, — или дождись сети, и поговорим подробнее.",
  "Я не притворяюсь, что офлайн могу говорить об этом бесконечно — возможностей правда немного. Но ты не один: как только будет связь, можно написать в WhatsApp ISWAN, а пока я рядом, насколько могу.",
];
